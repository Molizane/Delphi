...
uses
  ...
  Dialogs, Grids, StdCtrls, zFuzzy, AlignEdit, Buttons;
...
begin
  ...
  begin
    if Txt <> AnsiUpperCase(Txt) then
    begin
      GridDefuzzy.Canvas.Brush.Color := clNavy;
      GridDefuzzy.Canvas.Font.Color := clWhite;
    end
    else
    begin
...
begin
  ...
  Label3.Caption := FormatFloat(',0.0', FuzzySolution.RealOutput) + ' °';
  FuzzyAngulo.RealInput := FuzzyAngulo.RealInput + FuzzySolution.RealOutput;
end;

procedure TForm1.FuzzyDistanciaChange(Sender: TObject);
begin
  lblDistanciaValor.Caption := 'Valor=' + FloatToStrF(FuzzyDistancia.RealInput, ffFixed, 5, 1);
  lblDistanciaLE.Caption := 'LE=' + FloatToStrF(FuzzyDistancia.Outputs[0], ffFixed, 5, 1);
  lblDistanciaLC.Caption := 'LC=' + FloatToStrF(FuzzyDistancia.Outputs[1], ffFixed, 5, 1);
  lblDistanciaCE.Caption := 'CE=' + FloatToStrF(FuzzyDistancia.Outputs[2], ffFixed, 5, 1);
  lblDistanciaRC.Caption := 'RC=' + FloatToStrF(FuzzyDistancia.Outputs[3], ffFixed, 5, 1);
  lblDistanciaRI.Caption := 'RI=' + FloatToStrF(FuzzyDistancia.Outputs[4], ffFixed, 5, 1);
end;

procedure TForm1.FuzzyAnguloChange(Sender: TObject);
begin
  lblAnguloValor.Caption := 'Valor=' + FloatToStrF(FuzzyAngulo.RealInput, ffFixed, 5, 1);
  lblAnguloRB.Caption := 'RB=' + FloatToStrF(FuzzyAngulo.Outputs[0], ffFixed, 5, 1);
  lblAnguloRU.Caption := 'RU=' + FloatToStrF(FuzzyAngulo.Outputs[1], ffFixed, 5, 1);
  lblAnguloRV.Caption := 'RV=' + FloatToStrF(FuzzyAngulo.Outputs[2], ffFixed, 5, 1);
  lblAnguloVE.Caption := 'VE=' + FloatToStrF(FuzzyAngulo.Outputs[3], ffFixed, 5, 1);
  lblAnguloLV.Caption := 'LV=' + FloatToStrF(FuzzyAngulo.Outputs[4], ffFixed, 5, 1);
  lblAnguloLU.Caption := 'LU=' + FloatToStrF(FuzzyAngulo.Outputs[5], ffFixed, 5, 1);
  lblAnguloLB.Caption := 'LB=' + FloatToStrF(FuzzyAngulo.Outputs[6], ffFixed, 5, 1);
end;
