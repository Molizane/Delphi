...
type
  ...
  published
    ...
    property BorderStyle: TLedBorderStyle read FBorderStyle write SetBorderStyle default bsCtl3D;
    ...
    property LightOn: Boolean read FOn write SetLight default False;
